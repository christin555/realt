        ...
        public Objects(string _filtr)
      {
        ...
        private void GetObjects(int page)
        {
            ...
            for (int i=0;i< ds.Rows.Count; i++)
            {
                ...
                dataGridView1.Rows[i].Cells["Otype"].Value = Tools.GetDescription((Object.OType)ds.Rows[i]["type"]);
                dataGridView1.Rows[i].Cells["Address"].Value =ds.Rows[i]["address"];
                dataGridView1.Rows[i].Cells["Params"].Value = "Отделка: " + Tools.GetDescription((Object.Renovation)ds.Rows[i]["renovation"]) + Environment.NewLine+"Комн: " + ds.Rows[i]["rooms"] + Environment.NewLine +"Этаж: "+ ds.Rows[i]["floor"] + Environment.NewLine + "Площадь: " + ds.Rows[i]["area"] + Environment.NewLine + "Стены: " + Tools.GetDescription((Object.Wall)ds.Rows[i]["wall"]) +Environment.NewLine + "Год: " + ds.Rows[i]["year"];
